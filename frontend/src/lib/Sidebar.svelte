...
<div class="sidebar">
    ...
    <p class="sidebar-bio">
        ...
        in language design. I've worked with technologies such as React.JS,
        Next.JS, Svelte, FastAPI, PostgreSQL, Git, and Docker.
    </p>
    ...
    <div class="email-wrapper">
        ...
        >
            <p>Want to get in touch? Shoot me an email</p>
            <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                class="email-icon hvr-float"
                ><path
